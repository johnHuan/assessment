...
def execute_planning():
    ...
    # 将计算完成的地块文件复制到结果文件夹
    arcpy.CopyFeatures_management(config_dict['shp_path']["polygons"],
                                  os.path.join(config_dict['directories']["result_file"], "valuation_result.shp"))

    print("计算结果保存在：")
    print(os.path.join(config_dict['directories']["result_file"], "valuation_result.shp"))
